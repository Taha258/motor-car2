...
function CarCard({ car }) {
  return (
    <div className="group relative bg-[#0f172a] rounded-[2rem] overflow-hidden border border-white/5 hover:border-[#FAC104]/30 transition-all duration-500 shadow-xl">
      {/* Badge */}
      <div className="absolute top-6 left-6 z-10">
        <span className="bg-[#FAC104] text-white text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg shadow-[#FAC104]/20">
          Featured
        </span>
      </div>
      ...
      <div className="p-8 space-y-6">
        <div className="space-y-1">
          <p className="text-[#FAC104] text-xs font-bold uppercase tracking-[0.2em]">
            {car.brand} • {car.year}
          </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3 bg-white/5 rounded-xl p-3">
            <Gauge className="w-4 h-4 text-[#FAC104]" />
            <span className="text-white text-xs font-medium">{car.mileage || '0 KM'}</span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 rounded-xl p-3">
            <Settings className="w-4 h-4 text-[#FAC104]" />
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          ...
          <Link 
            ...
            className="w-12 h-12 bg-[#FAC104] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
          >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-[#0f172a] text-4xl md:text-5xl font-extrabold uppercase" style={{ fontFamily: 'Syne, sans-serif' }}>
              Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FAC104] to-[#FBDB5C]">Vehicles</span>
            </h2>
          </div>
          <Link 
            href="/showroom" 
