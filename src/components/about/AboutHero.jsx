    ...
    <section className="relative w-full h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl space-y-6">
        <div className="inline-block px-4 py-1.5 bg-[#31b56b]/20 backdrop-blur-md rounded-full border border-[#31b56b]/30 mb-4 animate-pulse">
          <span className="text-[#31b56b] text-xs font-bold tracking-[0.2em] uppercase">Legacy of Excellence</span>
        </div>
        <h1
        ...
        >
          REDEFINING THE <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#31b56b] to-[#4ade80]">AUTOMOTIVE</span> EXPERIENCE
        </h1>
