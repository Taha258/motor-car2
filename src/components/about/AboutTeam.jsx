      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
          <div className="space-y-4">
            ...
            >
              MEET THE <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#31b56b] to-[#4ade80]">SPECIALISTS</span>
            </h2>
          </div>
          <p
          ...
          {team.map((member) => (
            <div key={member.name} className="group">
              ...
              <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-8 shadow-2xl border border-gray-100">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a] via-transparent to-transparent opacity-0 group-hover:opacity-90 transition-opacity duration-500 flex flex-col justify-end p-8">
                  <div className="flex gap-3 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    <button className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center hover:bg-[#31b56b] transition-colors border border-white/10 text-white font-bold">
                      in
                    </button>
                    <button className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center hover:bg-[#31b56b] transition-colors border border-white/10 text-white font-bold">
                      @
              ...
              <div className="space-y-1 px-4">
                ...
                <p
                  className="text-[#31b56b] text-xs font-bold uppercase tracking-[0.2em]"
                  style={{ fontFamily: 'Space Grotesk, sans-serif' }}
                >
                  {member.role}
                </p>
