              ...
              <div className="p-10 md:p-12 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-3 text-gray-400">
                    <MapPin className="w-5 h-5 text-[#FAC104] shrink-0 mt-1" />
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white/5 hover:bg-[#FAC104] text-white px-8 py-4 rounded-2xl text-sm font-bold transition-all duration-300 border border-white/10 hover:border-[#FAC104] group/btn"
                >
