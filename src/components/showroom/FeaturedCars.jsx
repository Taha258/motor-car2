...
function CarCard({ car }) {
  return (
    <div className="group relative bg-[#0f172a] rounded-[2rem] overflow-hidden border border-white/5 hover:border-[#31b56b]/30 transition-all duration-500 shadow-xl hover:shadow-[#31b56b]/10">
      {/* Badge for Condition */}
      <div className="absolute top-6 left-6 z-10">
        <span className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider backdrop-blur-md border ${
          car.condition?.toLowerCase() === 'new' 
            ? 'bg-[#31b56b]/20 text-[#31b56b] border-[#31b56b]/30' 
      ...
      <div className="p-8 pt-6 space-y-6">
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <p className="text-[#31b56b] text-xs font-bold uppercase tracking-widest" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              {car.brand} • {car.year}
            </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={i} className="flex items-center gap-3 bg-white/5 rounded-2xl p-3 border border-white/5">
              <div className="w-8 h-8 rounded-lg bg-[#31b56b]/10 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <Link 
            ...
            className="flex items-center gap-2 bg-[#31b56b] hover:bg-[#28a05e] text-white px-6 py-3 rounded-xl text-sm font-bold transition-all duration-300 group/btn"
          >
            DETAILS
