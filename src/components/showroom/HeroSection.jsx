  ...
  return (
    <div className="relative flex-1" ref={ref}>
      <button
        ...
        className="w-full flex items-center justify-between bg-white text-gray-700 px-5 py-3.5 rounded-xl text-sm font-medium hover:bg-gray-50 transition-all duration-300 border border-transparent hover:border-[#31b56b]/30 shadow-sm"
      >
  ...
  return (
    <section className="relative w-full h-[450px] md:h-[500px] z-30 bg-[#0f172a]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 pt-10">
        ...
        >
          EXPLORE OUR <span className="text-[#31b56b]">SHOWROOM</span>
        </h1>
            ...
            <div className="flex gap-2 flex-[1.2]">
              <div className="relative flex-1 group">
                ...
                <input
                  ...
                  className="w-full bg-white text-[#0f172a] pl-11 pr-4 py-3.5 rounded-xl text-sm placeholder-gray-400 outline-none border border-transparent focus:border-[#31b56b]/50 shadow-sm transition-all"
                />
              </div>
              <button
                onClick={handleSearch}
                className="bg-[#31b56b] text-white px-6 py-3.5 rounded-xl text-sm font-bold hover:bg-[#28a05e] transition-all flex items-center justify-center gap-2 uppercase tracking-wider"
              >
