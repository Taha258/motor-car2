      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-[#31b56b]">COMMAND THE ROAD</span>
              </h2>
            </div>
            ...
            <div className="space-y-4 pt-4">
              {['White-glove service', 'Transparent pricing', 'Worldwide delivery'].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#31b56b]/10 flex items-center justify-center">
                    <CheckCircle2 className="w-3 h-3 text-[#31b56b]" />
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
            {/* Background Accent */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#31b56b]/5 to-transparent rounded-[3rem] -m-6" />
            
            {steps.map((step, index) => (
              <div 
                key={index} 
                className="group relative bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 hover:border-[#31b56b]/30 transition-all duration-500 hover:shadow-xl"
              >
                <div className="w-14 h-14 bg-[#f8f9fa] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#31b56b]/10 transition-colors">
                  <Image
                    src={step.icon}
                    alt={step.title}
                    width={28}
