            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '32px 36px' }}>
              ...
              <div style={{ backgroundColor: '#f0f0f0', borderRadius: '8px', padding: '20px 24px' }}>
                <p style={{ fontSize: '13px', color: '#444', lineHeight: '1.75', marginBottom: '12px' }}>
                  ...
                  <a href="https://www.pexels.com" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>Pexels</a>
                  . They are free for both personal and commercial use. You can find a link to the full license details below.
                </p>
                <ul style={{ paddingLeft: '20px', margin: 0 }}>
                  <li style={{ fontSize: '13px' }}>
                    <a href="https://www.pexels.com/license/" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>
                      Pexels Licence
                    </a>
                  </li>
                </ul>
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '32px 36px' }}>
              ...
              <div style={{ backgroundColor: '#f0f0f0', borderRadius: '8px', padding: '20px 24px' }}>
                <p style={{ fontSize: '13px', color: '#444', lineHeight: '1.75', marginBottom: '12px' }}>
                  ...
                  <a href="https://phosphoricons.com" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>Phosphor Icons</a>
                  . They are free for both personal and commercial use. You can find a link to the full license details below.
                </p>
                <ul style={{ paddingLeft: '20px', margin: 0 }}>
                  <li style={{ fontSize: '13px' }}>
                    <a href="https://github.com/phosphor-icons/core/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '32px 36px' }}>
              ...
              <div style={{ backgroundColor: '#f0f0f0', borderRadius: '8px', padding: '20px 24px' }}>
                <p style={{ fontSize: '13px', color: '#444', lineHeight: '1.75' }}>
                  ...
                  <a href="https://fonts.google.com/specimen/Syne" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>Syne</a>
                  {' '}and{' '}
                  <a href="https://fonts.google.com/specimen/Space+Grotesk" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>Space Grotesk</a>
                  . Both are available on{' '}
                  <a href="https://fonts.google.com" target="_blank" rel="noopener noreferrer" style={{ color: '#31b56b', textDecoration: 'none' }}>Google Fonts</a>
