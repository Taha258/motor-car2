              ...
              <div className="space-y-4">
                {relatedPosts.map((rp) => (
                  <Link key={rp.id} href={`/blog/${rp.slug}`} className="flex gap-3 group">
                    ...
                    <div>
                      <h4 className="text-[#0f172a] text-xs font-bold leading-snug group-hover:text-[#31b56b] transition-colors" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                        {rp.title}
                      </h4>
            ...
            <div className="bg-[#c8c8c8] rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((cat) => (
                  <span 
                    key={cat}
                    className="bg-[#0f172a] text-white text-xs px-4 py-2 rounded-lg cursor-pointer hover:bg-[#31b56b] transition-colors">
                    {cat}
                  </span>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedPosts.map((rp) => (
              <Link key={rp.id} href={`/blog/${rp.slug}`} className="group block">
                ...
                <h3 className="text-[#0f172a] text-sm font-bold leading-snug mb-3 group-hover:text-[#31b56b] transition-colors" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                  {rp.title}
                </h3>
