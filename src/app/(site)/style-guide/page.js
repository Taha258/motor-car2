...
const IconCheckCircle = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#31b56b" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="9 12 11 14 15 10"/></svg>
);
const IconDot = () => (
  <svg width="22" height="22" viewBox="0 0 24 24"><circle cx="12" cy="12" r="6" fill="#31b56b"/></svg>
);
const IconArrowUpRight = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#31b56b" strokeWidth="2.5"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg>
);
          ...
          <section id="colors">
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '28px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', marginBottom: '28px' }}>
                {[
                  { name: 'Emerald', hex: '#31B56B', sub: '#31 B5 6B\nRGB 49 181 107' },
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ backgroundColor: '#ebebeb', borderRadius: '8px', padding: '20px 24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <p style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '2.5px', color: '#31b56b', textTransform: 'uppercase' }}>
                    SUPERHEADLINE
                  </p>
              ...
              <div style={{ backgroundColor: '#ebebeb', borderRadius: '8px', padding: '20px 24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  <div style={{ marginTop: '10px' }}>
                    ...
                    <a href="#" style={{ fontSize: '13px', color: '#31b56b', textDecoration: 'underline', display: 'block', marginBottom: '3px' }}>Text link</a>
