          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden">
            ...
            <div className="bg-[#0f172a] p-10 md:p-12 flex flex-col justify-between relative">
              ...
              <div className="space-y-3 mt-10">
                <div className="bg-[#e8e8e8] rounded-xl p-3 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-[#31b56b]/20 flex items-center justify-center">
                    <Mail className="w-4 h-4 text-[#31b56b]" />
                  </div>
                  <div>
                    <p className="text-[#0f172a] text-xs font-medium">Email</p>
                    <p className="text-[#31b56b] text-sm font-medium">example@email.com</p>
                  </div>
                </div>

                <div className="bg-[#e8e8e8] rounded-xl p-3 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-[#31b56b]/20 flex items-center justify-center">
                    <Phone className="w-4 h-4 text-[#31b56b]" />
                  </div>
                  <div>
                    <p className="text-[#0f172a] text-xs font-medium">Phone</p>
                    <p className="text-[#31b56b] text-sm font-medium">+971 12 345 6789</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#d6d6d6] p-8 md:p-10">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="bg-[#31b56b] text-white text-xs font-semibold px-6 py-2.5 rounded-lg hover:bg-[#28a05e] transition-colors uppercase tracking-wider"
                  style={{ fontFamily: 'Space Grotesk, sans-serif' }}
                >
                  SUBMIT
                </button>
